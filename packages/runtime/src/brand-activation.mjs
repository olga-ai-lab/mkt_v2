/**
 * Ativacao de Brand Brain — onde o onboarding para e uma pessoa entra.
 *
 ...
 *
 * As lacunas nao bloqueiam — elas aparecem. Uma versao extraida de site chega
 * sempre sem proibicoes, porque uma pagina diz o que a marca fala e nao o que
 * ela se recusa a falar. Bloquear a ativacao por isso travaria o onboarding
 * inteiro atras de uma tela de edicao que ainda nao existe; deixar passar em
 * silencio faria o compliance.review conferir uma lista vazia para sempre, sem
 * ninguem perceber. Entao a ativacao acontece e diz o que ficou faltando.
 */
